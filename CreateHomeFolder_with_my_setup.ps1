...
$ADServer = 'a16johal' #change name to your DC
...
$searchbase = "DC=a16johal,DC=local" #Amend this to the actual OU. 
...
New-Item -ItemType Directory -Path "\\fileserver01s01\HomeFolders\$($ADUser.sAMAccountname)"
...
$userfolder = "\\fileserver01s01\HomeFolders\$($ADUser.sAMAccountname)"
...
$homeDirectory = "\\fileserver01s01\HomeFolders\$($ADUser.sAMAccountname)" #This maps the folder for each user 
